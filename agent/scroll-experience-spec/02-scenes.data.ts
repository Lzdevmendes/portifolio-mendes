...
export const DATASHEET: DatasheetRow[] = [
  ...
  // ⚠️ o valor abaixo precisa bater com Hero, Experience, ProjectsShowcase e o CV.
  // O repo hoje tem "$1.5M" e "$1.0M" em lugares diferentes — decidir e propagar.
  { key: { pt: "PROCESSADO", en: "PROCESSED" }, from: { type: "literal", value: "$1.0M+" } },
  { key: { pt: "CLIENTES", en: "CLIENTS" }, from: { type: "literal", value: "SABESP · PETROBRAS · MULTICLÍNICA" } },
